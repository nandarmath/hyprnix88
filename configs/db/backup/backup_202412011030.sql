...
;              
CREATE USER IF NOT EXISTS "SA" SALT 'b92bf112fa1d9b84' HASH '695d4a06eaf41b5bddfbe0e18cf9fef0aaa2a39edad5c5ff5d714ad1959107cb' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME") VALUES(1, NULL, 'web', TRUE, TRUE, '$2a$10$JdvcUFOqxY0CNKHiQlvh9OJbish1hvyFGMtY4aU5V//8RZKIGX3RW', NULL, 'admin');  
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME") VALUES(2, NULL, 'web', TRUE, FALSE, '$2a$10$5aXBxvV142UTPqRrG7NZ5.FjXwiyQDO1nf0WtOGmpiT1Ogiw5NIlK', NULL, 'STIRLING-PDF-BACKEND-API-USER');         
