...
in
{
  wayland.windowManager.hyprland.settings = {
    bind = [
      ...
      "$mod ,W,exec,[workspace 2 silent] uwsm app -- ${browser}"
      "$mod , minus, movetoworkspace,special"
      "$mod , equal, togglespecialworkspace"
      "$mod SHIFT,M,exec,emopicker9000"
      "$mod ,N,exec,[workspace 1 silent] uwsm app -- joplin-desktop"
      "$mod CONTROL,N,exec, uwsm app -- kitty -e joplin --profile ~/.config/joplin-desktop"
      "$mod ,S,exec,screenshootin"
      "$mod ,D,exec,uwsm app -- vesktop"
      "$mod ,R,exec,uwsm app -- libreoffice --writer"
      "$mod ,C,exec,uwsm app -- libreoffice --calc"
      "$mod ,T,exec,[workspace 9 silent] uwsm app -- telegram-desktop"
      ...
      "$mod ,Y,exec, uwsm app -- kitty -e ytfzf -t --thumb-viewer=kitty"
      "$mod ,O,exec,[workspace 5 silent ] uwsm app -- obs"
      "$mod ,G,exec,[workspace 4 silent ] uwsm app -- gimp"
      "$mod SHIFT,G,exec, fish -c record_scree_gif"
      "$mod ,E,exec,thunar"
      "$mod ,TAB,exec,rofi -show window -window-thumbnail"
      "$mod SHIFT,E,exec,kitty -e yazi"
      "$mod SHIFT,Y,exec,[ workspace 10 silent ] uwsm app -- kitty -e rmpc"
      "$mod ,X,killactive,"
      "$mod SHIFT,K,exec, uwsm app -- kitty -e nvim ~/hyprnix/config/home/hyprland/binds.nix"
      "$mod ,P,pseudo,"
