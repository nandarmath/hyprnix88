...
in {
  ...
  home.packages = with pkgs; [
    ...
    tdesktop rnote cinelerra quarto pfetch libsForQt5.kget rustdesk syncthing lunarvim yt-dlp pspp okular goldendict-ng scribus handbrake zotero joplin keepassxc
