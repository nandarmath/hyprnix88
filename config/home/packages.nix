...
in {
  ...
  home.packages = with pkgs; [
    ...
    rustup gparted zoom tenacity pavucontrol rofi-bluetooth pdfarranger chromium tgpt bat scrcpy mpd nodejs_21 jq drawio ferdium rclone rclone-browser krita sweethome3d.application sweethome3d.furniture-editor
