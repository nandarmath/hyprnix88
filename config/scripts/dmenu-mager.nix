...
pkgs.writeShellScriptBin "dmenu-mager" ''
  ...
  [
    ...
    [ "photopea",               "floorp --new-window --app=https://photopea.com/" ],
    ...
    [ "Zoom Meeting",           "floorp --new-window --app=https://zoom.us/id/join/" ],
    [ "Matlab",                 "brave --app=https://matlab.mathworks.com/" ],
    [ "TRanslate PDF",          "floorp --new-window --app=https://onlinedoctranslator.com/" ],
