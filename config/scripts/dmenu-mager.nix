...
pkgs.writeShellScriptBin "dmenu-mager" ''
  ...
  [
    ...
    [ "Chat GPT",               "chromium --app=https://chat.openai.com/" ],
    [ "Gemini",                 "chromium --app=https://gemini.google.com/" ],
    [ "Zoom Meeting",           "chromium --app=https://zoom.us/id/join/" ],
    [ "Remaker AI",             "chromium --app=https://remaker.ai/" ],
    [ "Blackbox AI",            "chromium --app=https://blackbox.ai/" ],
    [ "Image Creator AI",       "chromium --app=https://bing.com/images/create/" ],
    [ "Open Knowledges Maps",   "chromium --app=https://openknowledgemaps.org/" ],
    ...
    [ "facebook",               "chromium --app=https://m.facebook.com/" ],
