...
pkgs.writeShellScriptBin "dmenu-mager" ''
  ...
  [
    ...
    [ "Ekinerja",               "zen --new-window --app=https://kinerja.bkn.go.id/" ],
    [ "MyAsn",                  "zen --new-window --app=https://myasn.bkn.go.id/" ],
    [ "ASN Digital",            "zen --new-window --app=https://asndigital.bkn.go.id/" ],
